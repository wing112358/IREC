...
public class CarbonDataSourceConfig {
    ...
    static final String PACKAGE = "org.irecapi.dao";
    static final String MAPPER_LOCATION = "classpath:mapper/*.xml";


    //@Value 获取全局配置文件 application.properties 的 kv 配置,并自动装配
    @Value("${irec.datasource.url}")
    private String url;

    @Value("${irec.datasource.username}")
    private String user;

    @Value("${irec.datasource.password}")
    private String password;

    @Value("${irec.datasource.driverClassName}")
